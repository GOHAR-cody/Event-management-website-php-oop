...
<body>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" name="name" class="form-control bg-white border-0" id="name"
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="email" name="mail" class="form-control bg-white border-0" id="email"
                            ...
                            <div class="col-md-6">
                                <div class="form-floating date" id="date3" data-target-input="nearest">
                                    <input type="date" name="dob" class="form-control bg-white border-0" id="datetime"
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    ...
                                    <div class="tags-input-container" id="occ-tags-input-container">
                                        <input type="text" class="form-control" id="occ-tags-input"
                                            placeholder="Type a tag and press Enter " style="height:60px">
                                        <label style="color:white" for="achievements">Type of Occasions(you want to
                                            volunteer)</label>
                                    </div>
                                    <input type="hidden" name="occ" id="occ-hidden-tags">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-floating">
                                    ...
                                    <div class="tags-input-container" id="partners-tags-input-container">
                                        <input type="text" class="form-control" id="partners-tags-input"
                                            placeholder="Type a tag and press Enter " style="height:60px">
                                        <label style="color:white" for="partners">Personal Skills</label>
                                    </div>
                                    <input type="hidden" name="skills" id="partners-hidden-tags">
                                </div>
    ...
    $(document).ready(function() {
        ...
        handleTagsInput('occ-tags-input', 'occ-tags-input-container', 'occ-hidden-tags');
