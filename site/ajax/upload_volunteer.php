...
|| empty($exp)||empty($achi)||empty($skills)||empty($pwd)||empty($address2)||empty($img)||empty($pwd2))
{
  echo 4;
}
else {
...
if (mysqli_num_rows($emailResult) > 0) {
 ...
 $sqll="INSERT INTO `login_users`( `login_name`,`login_mail`, `login_pass`,`login_role`) VALUES ('$name','$mail', '$pwd', 3)";
